...
# OSM_FILE_PATH = "/home/minsang/submission_ws/src/planning/global_path_planning_sub/osm_files"
print(OSM_FILE_PATH)
# OSM_FILE_LIST = ["hitech_LINK.osm", "hitech_INTERSECTION_LINK.osm","hitech_tunnel.osm"]
# OSM_FILE_LIST = ["Hitech_uturn.osm"]
OSM_FILE_LIST = ['KCITY_sub_v4b.osm', 
